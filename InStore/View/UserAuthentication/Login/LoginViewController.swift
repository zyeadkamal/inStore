...
class LoginViewController: UIViewController {
    ...
    private lazy var viewModel: LoginViewModelProtocol = LoginViewModel(repository: Repository.shared(localDataSource: LocalDataSource.shared(managedContext: (UIApplication.shared.delegate as! AppDelegate).persistentContainer.viewContext)!,apiClient: ApiClient()))
